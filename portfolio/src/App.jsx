...
const Navbar = () => (
  <nav className="fixed top-0 w-full z-50 bg-[#0a0a0f]/80 backdrop-blur-md border-b border-white/5 px-8 py-4 flex justify-between items-center">
    ...
    <a href="https://res.cloudinary.com/dleauoiyo/raw/upload/v1776280590/Resume_mcdv4m.docx" target="_blank" className="px-5 py-2 rounded-full border border-[#00f0ff]/50 text-[#00f0ff] text-sm hover:bg-[#00f0ff]/10 transition-all">Resume</a>
  </nav>
);
